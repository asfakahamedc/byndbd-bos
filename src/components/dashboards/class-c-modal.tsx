...
export default function ClassCModal({
  ...
  return (
    <div 
      className={cn(
        "p-lg border rounded-none border-l-4 transition-colors duration-300",
        isConfirmed 
    ...
    >
      ...
      <div className="space-y-sm mb-4">
        ...
        <div className="flex items-center justify-between p-sm border border-outline-variant bg-white">
      ...
      {/* Interaction Button */}
      {bStatus === 'pending' ? (
        <div className="relative overflow-hidden border border-red-600 rounded-none bg-red-600 active:scale-[0.99] transition-transform">
        ...
        <div className="w-full bg-green-600 text-white font-bold py-2.5 px-4 rounded-none text-center text-xs tracking-wider uppercase flex items-center justify-center gap-2 border border-green-700">
