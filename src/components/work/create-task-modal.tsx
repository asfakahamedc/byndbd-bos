        ...
        <form onSubmit={handleSubmit} className="p-xl space-y-lg flex-1">
          ...
          <div className="space-y-xs">
            ...
            <select
              ...
              required
              disabled={isPending}
              className="w-full h-[40px] px-md border border-outline-variant bg-surface focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-body outline-none rounded-none"
            >
          ...
          <div className="space-y-xs">
            ...
            <textarea
              ...
              rows={3}
              disabled={isPending}
              className="w-full p-md border border-outline-variant bg-surface focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-body outline-none rounded-none resize-none"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-md pt-md border-t border-outline-variant">
            <button
              ...
              onClick={onClose}
              disabled={isPending}
              className="px-lg h-[40px] border border-outline bg-white hover:bg-surface-container-low text-on-surface font-bold text-body active:scale-[0.98] transition-all rounded-none"
            >
              Cancel
            </button>
            <button
